    ...
    public class SpriteImportData
    {
        ...
        public SpriteImportData(Sprite sprite, string assetPath)
        {
            ...
            else
            {
                ...
                dummySprite = Sprite.Create(
                    sprite.texture, sprite.rect, sprite.pivot, sprite.pixelsPerUnit, 0, SpriteMeshType.Tight, sprite.border);
                HasSpriteOutline = false;
            }
            _oldSourceAssetIdentifier =
                new AssetImporter.SourceAssetIdentifier(typeof(GameObject), Path.GetFileNameWithoutExtension(assetPath));
