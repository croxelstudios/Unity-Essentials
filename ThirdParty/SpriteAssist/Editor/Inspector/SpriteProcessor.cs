...
namespace SpriteAssist
{
    public class SpriteProcessor : IDisposable
    {
        ...
        public SpriteProcessor(Sprite sprite, string assetPath)
        {
            ...
            _originalUserData = (_mainImportData.textureImporter != null) ? _mainImportData.textureImporter.userData : "";
        ...
        public void OnInspectorGUI(bool disableBaseGUI)
        {
            ...
            if (_isDataChanged && (_mainImportData.textureImporter != null))
            {
        ...
        private void Revert()
        {
            ...
            _meshCreator = MeshCreatorBase.GetInstance(_configData.mode);
            _preview.SetWireframes(_meshCreator.GetMeshWireframes());
            if (_mainImportData.textureImporter != null)
        ...
        private void Apply(bool withMeshPrefabProcess = false, bool hasMeshPrefab = false, bool removeMeshPrefab = true, GameObject attachedMeshPrefab = null, bool withCopyFromSprite = false)
        {
            ...
            foreach (var selectedTarget in _targets)
            {
                if (SpriteImportData.TryGetSpriteImportData(selectedTarget, out var importData))
                {
                    if (importData.textureImporter != null)
                    ...
                    if (withCopyFromSprite)
                    {
                        ...
                        if ((rootSprite != null) && (importData.textureImporter != null))
                        {
